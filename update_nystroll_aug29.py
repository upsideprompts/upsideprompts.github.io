...
# Create baseball data for August 29-30, 2026 (current date is Saturday Aug 29)
baseballData = [
    {
...
# Create hiking data for August 29-30, 2026 (update from Aug 28-29 to Aug 29-30)
hikingData = [
    {
